...
class JetOrderShow extends Component
{
    public JetOrder $order;
    public $note;
    ...
    {
        $this->agentNotes = $this->order->client_notes;
    }

    public function updatedOrderStatus($newValue)
    {
        if ($newValue == JetOrder::STATUS_CANCELLED) {
    ...
    public function storeCancellationReason()
    {
        ...
        $this->order->status = JetOrder::STATUS_CANCELLED;
        $this->order->save();
...
//        );
    ...
    public function render()
    {
        ...
        return view('livewire.jet-orders.show', compact('cancellationReasons'));
    }
