...
class CreateDeliveryItemJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $response = (new ZohoBooksBranches($this->branch))->createDeliveryItem();
        ...
        if (isset($productResponse['item']) && isset($productResponse['item']['item_id'])) {
            ...
            $this->branch->zoho_books_delivery_item_id = $zoho_books_account_id;
            $this->branch->save();
        } else {
