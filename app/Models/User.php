 ...
 * @property float $wallet_reserved_total
 * @property float $wallet_free_total
 ...
 * @property-read \App\Models\Location $primaryAddress
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|User role($type)
