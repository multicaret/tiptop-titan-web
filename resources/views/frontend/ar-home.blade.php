                            ...
                            <div class="device-wrapper ">
                                <div class="device device-iphone-x">
                                    ...
                                    <img class="device-iphone-x-screen"
                                         src="/frontend-assets/images/screenshots-ar/1.png" alt="TipTop Screenshot">
                                </div>
                            </div>
                        </div>
                        <!-- End Device Mockup -->
        ...
        <div class="row justify-content-lg-between align-items-lg-center">
            <div class="col-lg-5 order-lg-2 mb-9 mb-lg-0">
                <div class="mb-5">
                    ...
                    <p>
                        استكشف المطاعم بمدينتك واختار شماتريد! عدنا مجموعة متنوعة من المطاعم والمأكولات والمشروبات وتگدر
                        تضيف اكثر
                        من عنوان واحد بحسابك! مكان البيت والعمل والأهل والأصدقاء! لأن ويا TipTop تگدر تضيف عناوين شگد
                        ماتريد!
                    </p>
                </div>
                ...
                <div class="position-relative max-w-50rem mx-auto" data-aos="fade-up">
                    ...
                    <div class="device device-iphone-x w-75 mx-auto">
                        <img class="device-iphone-x-frame" src="/frontend-assets/images/iphone-x.svg"
                             alt="Image Description">
                        <img class="device-iphone-x-screen"
                             src="/frontend-assets/images/screenshots-ar/RestauratnsList.png"
                             alt="Image Description">
                    </div>
                    <!-- End Device Mockup -->
        ...
        <div class="row justify-content-lg-between align-items-lg-center">
            <div class="col-lg-5 mb-9 mb-lg-0">
                <div class="mb-5">
                    ...
                    <p>
                        تگدر اتابع وين صار الاكل وشوكت رح يوصلك دقيقة بدقيقة، كل اللي عليك تحمل التطبيق واستمتع بمميزات
                        TipTop
                    </p>
                </div>
                ...
                <div class="row justify-content-md-center align-items-center mx-n2">
                    <div class="d-none d-md-inline-block col-md px-2">
                        <img class="img-fluid shadow rounded mb-3 mb-lg-5"
                             src="/frontend-assets/images/screenshots-ar/Home.png"
                             alt="Image Description">
                    ...
                    <div class="col-6 col-md px-2">
                        <img class="img-fluid shadow rounded mb-3 mb-lg-5"
                             src="/frontend-assets/images/screenshots-ar/menu.png"
                             alt="Image Description">
                    ...
                    <div class="col-3 col-md px-2"
                         data-parallaxanimation='[{property: "transform", value:" translate3d(0,@{{val}}rem,0)", initial:"-7", mid:"0", final:"7"}]'>
                        <img class="img-fluid shadow rounded mb-3 mb-lg-5"
                             src="/frontend-assets/images/screenshots-ar/orderconfirm.png"
                             alt="Image Description">
                        <!--                        <img class="img-fluid shadow rounded" src="../../../../assets/img/407x535/img1.jpg" alt="Image Description">-->
                    </div>
                    <div class="d-none d-md-inline-block col-md px-2">
                        <img class="img-fluid shadow rounded mb-3 mb-lg-5"
                             src="/frontend-assets/images/screenshots-ar/Checkout.png"
                             alt="Image Description">
    ...
    <div class="bg-light position-relative" id="lead-form-section">
        <div class="container pb-1">
            <div class="row justify-content-center mb-5">
                ...
                <div class="col-md-10 col-lg-7 mt-n11">
                    ...
                    <!--<form class="card p-4 p-md-5" method="POST" v-show="!isFormSent"
                        ...
                        <div class="text-center mb-4">
                            <h2>
                                لأنك غالي علينا… نص عليك ونص علينا 😃
                            </h2>
                            <p>
                                دزلنا رسالة وحمل التطبيق هسا
                            </p>
                        </div>
                        ...
                        <div class="row mx-n2">
                                ...
                                <div class="js-form-message">
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="first"
                                               placeholder="اسمك" aria-label="اسمك" required
                                               v-model="form.first">
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 px-2 mb-4">
                                ...
                                <div class="js-form-message">
                                    <div class="input-group">
                                        <input type="tel" class="form-control" name="phone" placeholder="الرقم"
                                               required dir="ltr"
                                               v-model="form.phone">
                        ...
                        <input type="hidden" name="locale" value="ar" v-model="form.locale">
            ...
            <!--<div class="text-center">
                <p class="small">
                    رح نتواصل وياك بأسرع وقت! شكراً لثقتك بينا
                </p>
            </div>-->
        </div>
    </div>
