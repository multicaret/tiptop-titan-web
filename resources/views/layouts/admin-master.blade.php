...
<head>
    ...
    <title>@yield('title', null) | TipTop {{__('Dashboard')}}</title>
    ...
    <link rel="stylesheet" href="{{ asset('/admin-assets/css/custom.css') }}?ver=1.3">
...
<!-- Core scripts -->
    ...
    <script>
        window.App = {!! json_encode([
            ...
            'translations' => [
                ...
                'working_day_0' => trans('strings.working_day_0'),
    ...
    @includeWhen(config('services.onesignal.dashboard_app_id'),'admin.notifications.onesignal-init')
